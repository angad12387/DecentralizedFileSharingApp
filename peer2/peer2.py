...
def main():
    ...
    if(op=="Y"):
        ...
        if passwordVerify("c31263f9a3a0dfde1ea3f5eb2cfd1562821ff42fb273a6bc0982b94669604119affd3b0e73fab5d8317215fec65bf1ea"):
            returnValue = recieve_client(IP,PORT3)
            if returnValue==1:
                main()
        
        print("Input password for Peer-1")
        if passwordVerify("d37336d89b1ec29f2ab906eb59f30d0b4a5209e4dae28103a4afb47cd8896950957e2947348c8414814ac2e1d2924783"):
                recieve_client(IP,PORT1)
                main()
